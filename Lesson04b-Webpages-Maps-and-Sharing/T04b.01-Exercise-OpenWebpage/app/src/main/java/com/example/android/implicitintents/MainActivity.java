...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // TODO (x5) Create a String that contains a URL ( make sure it starts with http:// or https:// )
        String url = "http://onesupremelife.tumblr.com";

        // TODO (x6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
        openWebPage(url);
    }
    ...
    // TODO (x1) Create a method called openWebPage that accepts a String as a parameter
    public void openWebPage(String url) {
        // TODO (x2) Use Uri.parse to parse the String into a Uri
        Uri webpage = Uri.parse(url);
        // TODO (x3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
