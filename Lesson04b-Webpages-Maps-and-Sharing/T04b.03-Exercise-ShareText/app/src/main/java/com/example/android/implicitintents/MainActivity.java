...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODO (x5) Specify a String you'd like to share
        String textToShare = "Hello world!";

        // TODO (x6) Replace the Toast with shareText, passing in the String from step 5
    ...
    // TODO (x1) Create a void method called shareText that accepts a String as a parameter
    private void shareText(String text){
        // TODO (x2) Create a String variable called mimeType and set it to "text/plain"
        // TODO (x3) Create a title for the chooser window that will pop up
        String mimeType = "text/plain", dialogTitle = getString(R.string.choose_app);

        // TODO (x4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
