    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (x1) Retrieve the text from the EditText and store it in a variable
                EditText entryEditText = (EditText) findViewById(R.id.et_text_entry);
                ...
                // TODO (x2) Use the putExtra method to put the String from the EditText in the Intent
                String userText = entryEditText.getText().toString();
                startChildActivityIntent.putExtra(Constants.TEXT_SENT+"", userText);
                /*
