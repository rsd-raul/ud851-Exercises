    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (x1) Store ChildActivity.class in a Class object called destinationActivity
                Class destinationActivity = ChildActivity.class;

                // TODO (x2) Create an Intent to start ChildActivity
                Intent intent = new Intent(context, destinationActivity);

                // TODO (x3) Replace the Toast with code to start ChildActivity
