...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (x1) Declare and instantiate an ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (x4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
        for (int i = mLifecycleCallbacks.size()-1; i >= 0; i--)
            mLifecycleDisplay.append(mLifecycleCallbacks.get(i) + "\n");

        // TODO (x5) Clear mLifecycleCallbacks after iterating through it
    ...
    protected void onStop() {
        ...
        // TODO (x2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // TODO (x3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
