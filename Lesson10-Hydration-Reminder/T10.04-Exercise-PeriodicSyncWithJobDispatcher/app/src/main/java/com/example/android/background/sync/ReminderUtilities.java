...
public class ReminderUtilities {
    // TODO (x15) Create three constants and one variable:
    ...
    private static final int REMINDER_INTERVAL_SECONDS = 15*60, SYNC_FLEXTIME_SECONDS = 15*60;
    private static final String REMINDER_JOB_TAG = "hydration_reminder_tag";
    private static boolean sInitialized = false;

    // TODO (x16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        // TODO (x17) If the job has already been initialized, return
        if(sInitialized)
            return;

        // TODO (x18) Create a new GooglePlayDriver
        Driver driver = new GooglePlayDriver(context);
        // TODO (x19) Create a new FirebaseJobDispatcher with the driver
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);

        // TODO (x20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TODO (x21) Use dispatcher's schedule method to schedule the job
        dispatcher.schedule(myJob);
        // TODO (x22) Set sInitialized to true to mark that we're done setting up the job
        sInitialized = true;
    }
}