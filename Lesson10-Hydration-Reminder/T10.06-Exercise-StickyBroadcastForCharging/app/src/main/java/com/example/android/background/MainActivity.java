...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // TODO (x1) Check if you are on Android M or later, if so...
        // TODO (x2) Get a BatteryManager instance using getSystemService()
        // charging method
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            isCharging = ((BatteryManager) getSystemService(BATTERY_SERVICE)).isCharging();

        // TODO (x4) If your user is not on M+, then...
        // TODO (x5) Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a
        // sticky broadcast that contains a lot of information about the battery state.
        // TODO (x6) Set a new Intent object equal to what is returned by registerReceiver, passing in null
        ...
        // TODO (x7) Get the integer extra BatteryManager.EXTRA_STATUS. Check if it matches
        ...
        // the battery is currently charging.
            ...
            if(status != -1)
                ...
                Log.e(TAG, "onResume: Error while retrieven the battery status");
        }

        // TODO (x3) Call isCharging on the battery manager and pass the result on to your show
        // TODO (x8) Update the UI using your showCharging method
